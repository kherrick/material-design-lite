 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nt(e,t=[]){const n=E.of(e);return{source:e,schemes:{light:v.light(e),dark:v.dark(e)},palettes:{primary:n.a1,secondary:n.a2,tertiary:n.a3,neutral:n.n1,neutralVariant:n.n2,error:n.error},customColors:t.map(r=>Vt(e,r))}}function Vt(e,t){let n=t.value;const r=n,o=e;t.blend&&(n=W.harmonize(r,o));const a=E.of(n).a1;return{color:t,value:n,light:{color:a.tone(40),onColor:a.tone(100),colorContainer:a.tone(90),onColorContainer:a.tone(10)},dark:{color:a.tone(80),onColor:a.tone(20),colorContainer:a.tone(30),onColorContainer:a.tone(90)}}}function qt(e,t,n=global,r={}){const o=St(t),{capture:a,passive:s,once:c}=r;j(()=>{o.current=t},[t]),j(()=>{if(!(n&&n.addEventListener))return;const h=l=>o.current(l),i={capture:a,passive:s,once:c};return n.addEventListener(e,h,i),()=>n.removeEventListener(e,h,i)},[e,n,a,s,c])}function Y(e){const t=document.querySelector('meta[name="theme-color"]');if(t)return t.setAttribute("content",e),t;{const n=document.createElement("meta");return n.setAttribute("name","theme-color"),n.setAttribute("content",e),document.head.appendChild(n),n}}function zt(){const e=localStorage.getItem("theme-color");if(e)return e;const t=document.querySelector('meta[name="theme-color"]');return t?t.getAttribute("content"):"#6750A4"}function Ut(e){const t=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e),{r:n,g:r,b:o}={r:parseInt(t[1],16),g:parseInt(t[2],16),b:parseInt(t[3],16)};return[n,r,o]}function ut(e,t){const n=`generated-material-${e}`;let r=document.getElementById(n);if(r==null){r=document.createElement("style"),r.id=n,r.type="text/css";const a=document.querySelector("material-css-adapter");a?a.parentNode.insertBefore(r,a):document.head.appendChild(r)}const o=t.match(/.{1,500}/g)||[];r.innerHTML="";for(const a of o)r.appendChild(document.createTextNode(a))}function lt(e){const t=Nt(Bt(e)),n=[];n.push(":where(.light-theme, .dark-theme) {"),n.push(`--md-source: ${e};`);function r(s,c){if(typeof c=="number")return st(c);if(s==="palettes"){const h=[100,99,98,95,90,80,70,60,50,40,35,30,25,20,10,5,0],i={};for(const[l,f]of Object.entries(c)){i[l]={};for(const m of h)i[l][m]=st(f.tone(m))}return i}return c}const o=JSON.parse(JSON.stringify(t,r,2));for(const[s,c]of Object.entries(o.palettes)){n.push(`  /* ${s} */`);for(const[h,i]of Object.entries(c)){const l=s.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase(),[f,m,p]=Ut(i);n.push(`  --md-ref-palette-${l}${h}-rgb: ${f}, ${m}, ${p};`)}}return n.push("}"),n.join(`
