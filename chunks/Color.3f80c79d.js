import{p as wt,y as St}from"./preact.module.8af602d9.js";import{s as At,_ as U,y as Tt}from"./hooks.module.5be5d437.js";import{e as rt}from"./jsxRuntime.module.f6a58cef.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lt=[[.41233895,.35762064,.18051042],[.2126,.7152,.0722],[.01932141,.11916382,.95034478]],vt=[[3.2413774792388685,-1.5376652402851851,-.49885366846268053],[-.9691452513005321,1.8758853451067872,.04156585616912061],[.05562093689691305,-.20395524564742123,1.0571799111220335]],Et=[95.047,100,108.883];function K(n,t,e){return(255<<24|(n&255)<<16|(t&255)<<8|e&255)>>>0}function at(n){const t=H(n[0]),e=H(n[1]),r=H(n[2]);return K(t,e,r)}function ct(n){return n>>16&255}function ht(n){return n>>8&255}function ut(n){return n&255}function kt(n,t,e){const r=vt,o=r[0][0]*n+r[0][1]*t+r[0][2]*e,a=r[1][0]*n+r[1][1]*t+r[1][2]*e,s=r[2][0]*n+r[2][1]*t+r[2][2]*e,c=H(o),h=H(a),i=H(s);return K(c,h,i)}function Dt(n){const t=N(ct(n)),e=N(ht(n)),r=N(ut(n));return _([t,e,r],Lt)}function xt(n){const t=j(n),e=H(t);return K(e,e,e)}function J(n){const t=Dt(n)[1];return 116*$t(t/100)-16}function j(n){return 100*Ht((n+16)/116)}function N(n){const t=n/255;return t<=.040449936?t/12.92*100:Math.pow((t+.055)/1.055,2.4)*100}function H(n){const t=n/100;let e=0;return t<=.0031308?e=t*12.92:e=1.055*Math.pow(t,1/2.4)-.055,Ot(0,255,Math.round(e*255))}function Ft(){return Et}function $t(n){const t=.008856451679035631,e=24389/27;return n>t?Math.pow(n,1/3):(e*n+16)/116}function Ht(n){const t=.008856451679035631,e=24389/27,r=n*n*n;return r>t?r:(116*n-16)/e}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const st=n=>{const t=ct(n),e=ht(n),r=ut(n),o=[t.toString(16),e.toString(16),r.toString(16)];for(const[a,s]of o.entries())s.length===1&&(o[a]="0"+s);return"#"+o.join("")},Bt=n=>{n=n.replace("#","");const t=n.length===3,e=n.length===6,r=n.length===8;if(!t&&!e&&!r)throw new Error("unexpected hex "+n);let o=0,a=0,s=0;return t?(o=L(n.slice(0,1).repeat(2)),a=L(n.slice(1,2).repeat(2)),s=L(n.slice(2,3).repeat(2))):e?(o=L(n.slice(0,2)),a=L(n.slice(2,4)),s=L(n.slice(4,6))):r&&(o=L(n.slice(2,4)),a=L(n.slice(4,6)),s=L(n.slice(6,8))),(255<<24|(o&255)<<16|(a&255)<<8|s&255)>>>0};function L(n){return parseInt(n,16)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nt(n,t=[]){const e=E.of(n);return{source:n,schemes:{light:v.light(n),dark:v.dark(n)},palettes:{primary:e.a1,secondary:e.a2,tertiary:e.a3,neutral:e.n1,neutralVariant:e.n2,error:e.error},customColors:t.map(r=>Vt(n,r))}}function Vt(n,t){let e=t.value;const r=e,o=n;t.blend&&(e=Q.harmonize(r,o));const a=E.of(e).a1;return{color:t,value:e,light:{color:a.tone(40),onColor:a.tone(100),colorContainer:a.tone(90),onColorContainer:a.tone(10)},dark:{color:a.tone(80),onColor:a.tone(20),colorContainer:a.tone(30),onColorContainer:a.tone(90)}}}function qt(n,t,e=global,r={}){const o=At(t),{capture:a,passive:s,once:c}=r;U(()=>{o.current=t},[t]),U(()=>{if(!(e&&e.addEventListener))return;const h=l=>o.current(l),i={capture:a,passive:s,once:c};return e.addEventListener(n,h,i),()=>e.removeEventListener(n,h,i)},[n,e,a,s,c])}function Y(n){const t=document.querySelector('meta[name="theme-color"]');if(t)return t.setAttribute("content",n),t;{const e=document.createElement("meta");return e.setAttribute("name","theme-color"),e.setAttribute("content",n),document.head.appendChild(e),e}}function zt(){const n=localStorage.getItem("theme-color");if(n)return n;const t=document.querySelector('meta[name="theme-color"]');return t?t.getAttribute("content"):"#6750A4"}function it(n){const t=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(n),{r:e,g:r,b:o}={r:parseInt(t[1],16),g:parseInt(t[2],16),b:parseInt(t[3],16)};return[e,r,o]}function lt(n,t){const e=`generated-material-${n}`;let r=document.getElementById(e);r==null&&(r=document.createElement("style"),r.id=e,r.type="text/css",document.head.appendChild(r));const o=t.match(/.{1,500}/g)||[];for(const a of o)r.appendChild(document.createTextNode(a))}function ft(n){const t=Nt(Bt(n)),e=[];e.push("body, .tokens {"),e.push(`--md-source: ${n};`);function r(s,c){if(typeof c=="number")return st(c);if(s==="palettes"){const h=[100,99,98,95,90,80,70,60,50,40,35,30,25,20,10,5,0],i={};for(const[l,f]of Object.entries(c)){i[l]={};for(const m of h)i[l][m]=st(f.tone(m))}return i}return c}const o=JSON.parse(JSON.stringify(t,r,2));for(const[s,c]of Object.entries(o.schemes)){e.push(`  /* ${s} */`);for(const[h,i]of Object.entries(c)){const l=h.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase(),[f,m,p]=it(i);e.push(`  --md-sys-color-${l}-rgb-${s}: ${f}, ${m}, ${p};`)}}for(const[s,c]of Object.entries(o.palettes)){e.push(`  /* ${s} */`);for(const[h,i]of Object.entries(c)){const l=s.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase(),[f,m,p]=it(i);e.push(`  --md-ref-palette-${l}${h}-rgb: ${f}, ${m}, ${p};`)}}return e.push("}"),e.join(`
`)}function Jt(n){const t=ft(n);lt("tokens",t),Y(n),localStorage.setItem("theme-color",n),window.dispatchEvent(new CustomEvent("theme-color-changed",{detail:n}))}const Yt=()=>{const[n,t]=Tt(zt()),e=St(),r=o=>{t(o),Y(o),localStorage.setItem("theme-color",o)};return U(()=>{const o=ft(n);lt("tokens",o)},[n]),qt("theme-color-changed",o=>{console.log(o);const a=o.detail;t(a),Y(a),e.current.value=a},window),rt(wt,{children:rt("input",{ref:e,type:"color",value:n,onInput:o=>{const a=o.target.value;r(a)}})})};export{Yt as C,Jt as s};
