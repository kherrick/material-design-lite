import{p as bt,y as wt}from"./preact.module.8af602d9.js";import{s as St,_ as U,y as At}from"./hooks.module.5be5d437.js";import{e as rt}from"./jsxRuntime.module.f6a58cef.js";/**
 * @license
...
`)}function Jt(n){const t=lt(n);ut("tokens",t),Y(n),localStorage.setItem("theme-color",n),window.dispatchEvent(new CustomEvent("theme-color-changed",{detail:n}))}const Yt=()=>{const[n,t]=At(qt()),e=wt(),r=o=>{t(o),Y(o),localStorage.setItem("theme-color",o)};return U(()=>{const o=lt(n);ut("tokens",o)},[n]),$t("theme-color-changed",o=>{console.log(o);const a=o.detail;t(a),Y(a),e.current.value=a},window),rt(bt,{children:rt("input",{ref:e,type:"color",value:n,onInput:o=>{const a=o.target.value;r(a)}})})};export{Yt as C,Jt as s};
