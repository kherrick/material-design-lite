...
`).map(t=>t.replace(/^    /,"")).join(`
`),e=e.trim(),i.files["main.ts"]={content:e}}p.config=i};return g(()=>o(),[]),c(m,{children:c("playground-ide",{id:"playground",class:"playground-theme-material",ref:n,"editable-file-system":!0,"line-numbers":!0,resizable:!0,style:{height:"100%",width:"100%","--playground-preview-width":"50%"}})})};export{u as default};
